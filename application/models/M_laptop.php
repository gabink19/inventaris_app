...
class M_laptop extends CI_Model {    
    ...
    function semua() {
        ...
        $query = $this->db->query("SELECT tb_inv_laptop.*,tb_inv_laptop.id_laptop,tb_inv_laptop.kode_laptop,tb_pengguna.nama_pengguna,tb_departemen.id_dept,
    ...
    function getall($id) {        
        $query = $this->db->query("SELECT tb_inv_laptop.*,tb_pengguna.id_pengguna,tb_pengguna.nama_pengguna,tb_departemen.id_dept,
            tb_departemen.nama,tb_departemen.parent
            FROM tb_inv_laptop INNER JOIN tb_pengguna ON tb_pengguna.id_pengguna = tb_inv_laptop.id_pengguna 
    ...
    function simpan($data) {
        ...
        if (!file_exists($penyimpanan))
         mkdir($penyimpanan);
        $filename = $penyimpanan.$data['kode_laptop'].".png";
        if (!file_exists($filename)){
            $qr = QRcode::png($data['kode_laptop'],$filename,10,10);
        }
